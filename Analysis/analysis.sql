...
FROM 'C:\Users\Hassan\Documents\PostgreSQL\Analysis\MPI_Directory_by_Establishment_Name.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
...
COPY state_regions
FROM 'C:\Users\Hassan\Documents\PostgreSQL\Analysis\state_regions.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
